        ...
        <Row style={{ justifyContent: 'center', paddingBottom: '10px' }}>
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              code="https://github.com/GSG-G11/Quizzer"
              demo="https://quizzer-g11.herokuapp.com"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              code="https://github.com/GSG-G11/e-store"
              demo="https://e-store-g11.herokuapp.com"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              code="https://github.com/GSG-G11/Zaher-Reddit"
              demo="https://zaher-reddit.herokuapp.com"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              code="https://github.com/GSG-G11/Blog-Post"
              demo="https://blog-post4.herokuapp.com"
            />
          </Col>
        </Row>
      </Container>
